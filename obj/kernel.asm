...
kern_init(void) {
  ...
  100023:	e8 56 33 00 00       	call   10337e <memset>
  ...
  100051:	e8 7f 29 00 00       	call   1029d5 <pmm_init>
...
vcprintf(const char *fmt, va_list ap) {
  ...
  100314:	e8 90 28 00 00       	call   102ba9 <vprintfmt>
    return cnt;
...
debuginfo_eip(uintptr_t addr, struct eipdebuginfo *info) {
  ...
  1006c3:	e8 2e 2b 00 00       	call   1031f6 <strfind>
...
print_kerninfo(void) {
  ...
  100869:	c7 44 24 04 0a 35 10 	movl   $0x10350a,0x4(%esp)
  100870:	00 
...
parse(char *buf, char **argv) {
  ...
  100a86:	e8 37 27 00 00       	call   1031c2 <strchr>
  ...
  100af0:	e8 cd 26 00 00       	call   1031c2 <strchr>
...
runcmd(char *buf, struct trapframe *tf) {
  ...
  100b5a:	e8 c7 25 00 00       	call   103126 <strcmp>
...
kmonitor(struct trapframe *tf) {
  ...
  100be8:	e8 66 0e 00 00       	call   101a53 <print_trapframe>
    }
...
cga_putc(int c) {
  ...
  1011ea:	e8 d1 21 00 00       	call   1033c0 <memmove>
...
idt_init(void) {
  ...
  10196f:	81 7d fc ff 00 00 00 	cmpl   $0xff,-0x4(%ebp)
  101976:	0f 8e 2f ff ff ff    	jle    1018ab <idt_init+0x12>
    }
    SETGATE(idt[T_SWITCH_TOK], 0, GD_KTEXT, __vectors[T_SWITCH_TOK], DPL_USER);
  10197c:	a1 c4 f7 10 00       	mov    0x10f7c4,%eax
  101981:	0f b7 c0             	movzwl %ax,%eax
  101984:	66 a3 68 04 11 00    	mov    %ax,0x110468
  10198a:	66 c7 05 6a 04 11 00 	movw   $0x8,0x11046a
  101991:	08 00 
  101993:	0f b6 05 6c 04 11 00 	movzbl 0x11046c,%eax
  10199a:	24 e0                	and    $0xe0,%al
  10199c:	a2 6c 04 11 00       	mov    %al,0x11046c
  1019a1:	0f b6 05 6c 04 11 00 	movzbl 0x11046c,%eax
  1019a8:	24 1f                	and    $0x1f,%al
  1019aa:	a2 6c 04 11 00       	mov    %al,0x11046c
  1019af:	0f b6 05 6d 04 11 00 	movzbl 0x11046d,%eax
  1019b6:	24 f0                	and    $0xf0,%al
  1019b8:	0c 0e                	or     $0xe,%al
  1019ba:	a2 6d 04 11 00       	mov    %al,0x11046d
  1019bf:	0f b6 05 6d 04 11 00 	movzbl 0x11046d,%eax
  1019c6:	24 ef                	and    $0xef,%al
  1019c8:	a2 6d 04 11 00       	mov    %al,0x11046d
  1019cd:	0f b6 05 6d 04 11 00 	movzbl 0x11046d,%eax
  1019d4:	0c 60                	or     $0x60,%al
  1019d6:	a2 6d 04 11 00       	mov    %al,0x11046d
  1019db:	0f b6 05 6d 04 11 00 	movzbl 0x11046d,%eax
  1019e2:	0c 80                	or     $0x80,%al
  1019e4:	a2 6d 04 11 00       	mov    %al,0x11046d
  1019e9:	a1 c4 f7 10 00       	mov    0x10f7c4,%eax
  1019ee:	c1 e8 10             	shr    $0x10,%eax
  1019f1:	0f b7 c0             	movzwl %ax,%eax
  1019f4:	66 a3 6e 04 11 00    	mov    %ax,0x11046e
  1019fa:	c7 45 f8 60 f5 10 00 	movl   $0x10f560,-0x8(%ebp)
    asm volatile ("lidt (%0)" :: "r" (pd));
...
trapname(int trapno) {
  ...
  101a13:	83 f8 13             	cmp    $0x13,%eax
  101a16:	77 0c                	ja     101a24 <trapname+0x17>
        return excnames[trapno];
  101a18:	8b 45 08             	mov    0x8(%ebp),%eax
  101a1b:	8b 04 85 e0 3b 10 00 	mov    0x103be0(,%eax,4),%eax
  101a22:	eb 18                	jmp    101a3c <trapname+0x2f>
    }
    if (trapno >= IRQ_OFFSET && trapno < IRQ_OFFSET + 16) {
  101a24:	83 7d 08 1f          	cmpl   $0x1f,0x8(%ebp)
  101a28:	7e 0d                	jle    101a37 <trapname+0x2a>
  101a2a:	83 7d 08 2f          	cmpl   $0x2f,0x8(%ebp)
  101a2e:	7f 07                	jg     101a37 <trapname+0x2a>
        return "Hardware Interrupt";
  101a30:	b8 8a 38 10 00       	mov    $0x10388a,%eax
  101a35:	eb 05                	jmp    101a3c <trapname+0x2f>
    }
    return "(unknown trap)";
  101a37:	b8 9d 38 10 00       	mov    $0x10389d,%eax
}
  101a3c:	5d                   	pop    %ebp
  101a3d:	c3                   	ret    

00101a3e <trap_in_kernel>:

/* trap_in_kernel - test if trap happened in kernel */
bool
trap_in_kernel(struct trapframe *tf) {
  101a3e:	55                   	push   %ebp
  101a3f:	89 e5                	mov    %esp,%ebp
    return (tf->tf_cs == (uint16_t)KERNEL_CS);
  101a41:	8b 45 08             	mov    0x8(%ebp),%eax
  101a44:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
  101a48:	83 f8 08             	cmp    $0x8,%eax
  101a4b:	0f 94 c0             	sete   %al
  101a4e:	0f b6 c0             	movzbl %al,%eax
}
  101a51:	5d                   	pop    %ebp
  101a52:	c3                   	ret    

00101a53 <print_trapframe>:
...
print_trapframe(struct trapframe *tf) {
  101a53:	55                   	push   %ebp
  101a54:	89 e5                	mov    %esp,%ebp
  101a56:	83 ec 28             	sub    $0x28,%esp
    cprintf("trapframe at %p\n", tf);
  101a59:	8b 45 08             	mov    0x8(%ebp),%eax
  101a5c:	89 44 24 04          	mov    %eax,0x4(%esp)
  101a60:	c7 04 24 de 38 10 00 	movl   $0x1038de,(%esp)
  101a67:	e8 b4 e8 ff ff       	call   100320 <cprintf>
    print_regs(&tf->tf_regs);
  101a6c:	8b 45 08             	mov    0x8(%ebp),%eax
  101a6f:	89 04 24             	mov    %eax,(%esp)
  101a72:	e8 8f 01 00 00       	call   101c06 <print_regs>
    cprintf("  ds   0x----%04x\n", tf->tf_ds);
  101a77:	8b 45 08             	mov    0x8(%ebp),%eax
  101a7a:	0f b7 40 2c          	movzwl 0x2c(%eax),%eax
  101a7e:	89 44 24 04          	mov    %eax,0x4(%esp)
  101a82:	c7 04 24 ef 38 10 00 	movl   $0x1038ef,(%esp)
  101a89:	e8 92 e8 ff ff       	call   100320 <cprintf>
    cprintf("  es   0x----%04x\n", tf->tf_es);
  101a8e:	8b 45 08             	mov    0x8(%ebp),%eax
  101a91:	0f b7 40 28          	movzwl 0x28(%eax),%eax
  101a95:	89 44 24 04          	mov    %eax,0x4(%esp)
  101a99:	c7 04 24 02 39 10 00 	movl   $0x103902,(%esp)
  101aa0:	e8 7b e8 ff ff       	call   100320 <cprintf>
    cprintf("  fs   0x----%04x\n", tf->tf_fs);
  101aa5:	8b 45 08             	mov    0x8(%ebp),%eax
  101aa8:	0f b7 40 24          	movzwl 0x24(%eax),%eax
  101aac:	89 44 24 04          	mov    %eax,0x4(%esp)
  101ab0:	c7 04 24 15 39 10 00 	movl   $0x103915,(%esp)
  101ab7:	e8 64 e8 ff ff       	call   100320 <cprintf>
    cprintf("  gs   0x----%04x\n", tf->tf_gs);
  101abc:	8b 45 08             	mov    0x8(%ebp),%eax
  101abf:	0f b7 40 20          	movzwl 0x20(%eax),%eax
  101ac3:	89 44 24 04          	mov    %eax,0x4(%esp)
  101ac7:	c7 04 24 28 39 10 00 	movl   $0x103928,(%esp)
  101ace:	e8 4d e8 ff ff       	call   100320 <cprintf>
    cprintf("  trap 0x%08x %s\n", tf->tf_trapno, trapname(tf->tf_trapno));
  101ad3:	8b 45 08             	mov    0x8(%ebp),%eax
  101ad6:	8b 40 30             	mov    0x30(%eax),%eax
  101ad9:	89 04 24             	mov    %eax,(%esp)
  101adc:	e8 2c ff ff ff       	call   101a0d <trapname>
  ...
  101aef:	c7 04 24 3b 39 10 00 	movl   $0x10393b,(%esp)
  101af6:	e8 25 e8 ff ff       	call   100320 <cprintf>
    cprintf("  err  0x%08x\n", tf->tf_err);
  101afb:	8b 45 08             	mov    0x8(%ebp),%eax
  101afe:	8b 40 34             	mov    0x34(%eax),%eax
  101b01:	89 44 24 04          	mov    %eax,0x4(%esp)
  101b05:	c7 04 24 4d 39 10 00 	movl   $0x10394d,(%esp)
  101b0c:	e8 0f e8 ff ff       	call   100320 <cprintf>
    cprintf("  eip  0x%08x\n", tf->tf_eip);
  101b11:	8b 45 08             	mov    0x8(%ebp),%eax
  101b14:	8b 40 38             	mov    0x38(%eax),%eax
  101b17:	89 44 24 04          	mov    %eax,0x4(%esp)
  101b1b:	c7 04 24 5c 39 10 00 	movl   $0x10395c,(%esp)
  101b22:	e8 f9 e7 ff ff       	call   100320 <cprintf>
    cprintf("  cs   0x----%04x\n", tf->tf_cs);
  101b27:	8b 45 08             	mov    0x8(%ebp),%eax
  101b2a:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
  101b2e:	89 44 24 04          	mov    %eax,0x4(%esp)
  101b32:	c7 04 24 6b 39 10 00 	movl   $0x10396b,(%esp)
  ...
  101b48:	c7 04 24 7e 39 10 00 	movl   $0x10397e,(%esp)
  ...
  101b62:	eb 3d                	jmp    101ba1 <print_trapframe+0x14e>
  ...
  101b71:	74 28                	je     101b9b <print_trapframe+0x148>
  101b73:	8b 45 f4             	mov    -0xc(%ebp),%eax
  101b76:	8b 04 85 80 f5 10 00 	mov    0x10f580(,%eax,4),%eax
  101b7d:	85 c0                	test   %eax,%eax
  101b7f:	74 1a                	je     101b9b <print_trapframe+0x148>
            cprintf("%s,", IA32flags[i]);
  101b81:	8b 45 f4             	mov    -0xc(%ebp),%eax
  101b84:	8b 04 85 80 f5 10 00 	mov    0x10f580(,%eax,4),%eax
  101b8b:	89 44 24 04          	mov    %eax,0x4(%esp)
  101b8f:	c7 04 24 8d 39 10 00 	movl   $0x10398d,(%esp)
  101b96:	e8 85 e7 ff ff       	call   100320 <cprintf>
    for (i = 0, j = 1; i < sizeof(IA32flags) / sizeof(IA32flags[0]); i ++, j <<= 1) {
  101b9b:	ff 45 f4             	incl   -0xc(%ebp)
  101b9e:	d1 65 f0             	shll   -0x10(%ebp)
  101ba1:	8b 45 f4             	mov    -0xc(%ebp),%eax
  101ba4:	83 f8 17             	cmp    $0x17,%eax
  101ba7:	76 bb                	jbe    101b64 <print_trapframe+0x111>
        }
    }
    cprintf("IOPL=%d\n", (tf->tf_eflags & FL_IOPL_MASK) >> 12);
  101ba9:	8b 45 08             	mov    0x8(%ebp),%eax
  101bac:	8b 40 40             	mov    0x40(%eax),%eax
  101baf:	c1 e8 0c             	shr    $0xc,%eax
  101bb2:	83 e0 03             	and    $0x3,%eax
  101bb5:	89 44 24 04          	mov    %eax,0x4(%esp)
  101bb9:	c7 04 24 91 39 10 00 	movl   $0x103991,(%esp)
  101bc0:	e8 5b e7 ff ff       	call   100320 <cprintf>

    if (!trap_in_kernel(tf)) {
  101bc5:	8b 45 08             	mov    0x8(%ebp),%eax
  101bc8:	89 04 24             	mov    %eax,(%esp)
  101bcb:	e8 6e fe ff ff       	call   101a3e <trap_in_kernel>
  101bd0:	85 c0                	test   %eax,%eax
  101bd2:	75 2d                	jne    101c01 <print_trapframe+0x1ae>
        cprintf("  esp  0x%08x\n", tf->tf_esp);
  101bd4:	8b 45 08             	mov    0x8(%ebp),%eax
  101bd7:	8b 40 44             	mov    0x44(%eax),%eax
  101bda:	89 44 24 04          	mov    %eax,0x4(%esp)
  101bde:	c7 04 24 9a 39 10 00 	movl   $0x10399a,(%esp)
  101be5:	e8 36 e7 ff ff       	call   100320 <cprintf>
        cprintf("  ss   0x----%04x\n", tf->tf_ss);
  101bea:	8b 45 08             	mov    0x8(%ebp),%eax
  101bed:	0f b7 40 48          	movzwl 0x48(%eax),%eax
  101bf1:	89 44 24 04          	mov    %eax,0x4(%esp)
  101bf5:	c7 04 24 a9 39 10 00 	movl   $0x1039a9,(%esp)
  101bfc:	e8 1f e7 ff ff       	call   100320 <cprintf>
    }
}
  101c01:	90                   	nop
  101c02:	89 ec                	mov    %ebp,%esp
  101c04:	5d                   	pop    %ebp
  101c05:	c3                   	ret    
...
print_regs(struct pushregs *regs) {
  ...
  101c09:	83 ec 18             	sub    $0x18,%esp
    cprintf("  edi  0x%08x\n", regs->reg_edi);
  101c0c:	8b 45 08             	mov    0x8(%ebp),%eax
  101c0f:	8b 00                	mov    (%eax),%eax
  101c11:	89 44 24 04          	mov    %eax,0x4(%esp)
  101c15:	c7 04 24 bc 39 10 00 	movl   $0x1039bc,(%esp)
  101c1c:	e8 ff e6 ff ff       	call   100320 <cprintf>
    cprintf("  esi  0x%08x\n", regs->reg_esi);
  101c21:	8b 45 08             	mov    0x8(%ebp),%eax
  101c24:	8b 40 04             	mov    0x4(%eax),%eax
  101c27:	89 44 24 04          	mov    %eax,0x4(%esp)
  101c2b:	c7 04 24 cb 39 10 00 	movl   $0x1039cb,(%esp)
  101c32:	e8 e9 e6 ff ff       	call   100320 <cprintf>
    cprintf("  ebp  0x%08x\n", regs->reg_ebp);
  101c37:	8b 45 08             	mov    0x8(%ebp),%eax
  101c3a:	8b 40 08             	mov    0x8(%eax),%eax
  101c3d:	89 44 24 04          	mov    %eax,0x4(%esp)
  101c41:	c7 04 24 da 39 10 00 	movl   $0x1039da,(%esp)
  101c48:	e8 d3 e6 ff ff       	call   100320 <cprintf>
    cprintf("  oesp 0x%08x\n", regs->reg_oesp);
  101c4d:	8b 45 08             	mov    0x8(%ebp),%eax
  101c50:	8b 40 0c             	mov    0xc(%eax),%eax
  101c53:	89 44 24 04          	mov    %eax,0x4(%esp)
  101c57:	c7 04 24 e9 39 10 00 	movl   $0x1039e9,(%esp)
  101c5e:	e8 bd e6 ff ff       	call   100320 <cprintf>
    cprintf("  ebx  0x%08x\n", regs->reg_ebx);
  101c63:	8b 45 08             	mov    0x8(%ebp),%eax
  101c66:	8b 40 10             	mov    0x10(%eax),%eax
  101c69:	89 44 24 04          	mov    %eax,0x4(%esp)
  101c6d:	c7 04 24 f8 39 10 00 	movl   $0x1039f8,(%esp)
  101c74:	e8 a7 e6 ff ff       	call   100320 <cprintf>
    cprintf("  edx  0x%08x\n", regs->reg_edx);
  101c79:	8b 45 08             	mov    0x8(%ebp),%eax
  101c7c:	8b 40 14             	mov    0x14(%eax),%eax
  101c7f:	89 44 24 04          	mov    %eax,0x4(%esp)
  101c83:	c7 04 24 07 3a 10 00 	movl   $0x103a07,(%esp)
  101c8a:	e8 91 e6 ff ff       	call   100320 <cprintf>
    cprintf("  ecx  0x%08x\n", regs->reg_ecx);
  101c8f:	8b 45 08             	mov    0x8(%ebp),%eax
  101c92:	8b 40 18             	mov    0x18(%eax),%eax
  101c95:	89 44 24 04          	mov    %eax,0x4(%esp)
  101c99:	c7 04 24 16 3a 10 00 	movl   $0x103a16,(%esp)
  101ca0:	e8 7b e6 ff ff       	call   100320 <cprintf>
    cprintf("  eax  0x%08x\n", regs->reg_eax);
  101ca5:	8b 45 08             	mov    0x8(%ebp),%eax
  101ca8:	8b 40 1c             	mov    0x1c(%eax),%eax
  101cab:	89 44 24 04          	mov    %eax,0x4(%esp)
  101caf:	c7 04 24 25 3a 10 00 	movl   $0x103a25,(%esp)
  101cb6:	e8 65 e6 ff ff       	call   100320 <cprintf>
}
  101cbb:	90                   	nop
  101cbc:	89 ec                	mov    %ebp,%esp
  101cbe:	5d                   	pop    %ebp
  101cbf:	c3                   	ret    
...
trap_dispatch(struct trapframe *tf) {
  ...
  101ccc:	83 f8 79             	cmp    $0x79,%eax
  101ccf:	0f 87 e6 00 00 00    	ja     101dbb <trap_dispatch+0xfb>
  101cd5:	83 f8 78             	cmp    $0x78,%eax
  101cd8:	0f 83 c1 00 00 00    	jae    101d9f <trap_dispatch+0xdf>
  101cde:	83 f8 2f             	cmp    $0x2f,%eax
  101ce1:	0f 87 d4 00 00 00    	ja     101dbb <trap_dispatch+0xfb>
  101ce7:	83 f8 2e             	cmp    $0x2e,%eax
  101cea:	0f 83 00 01 00 00    	jae    101df0 <trap_dispatch+0x130>
  101cf0:	83 f8 24             	cmp    $0x24,%eax
  101cf3:	74 5e                	je     101d53 <trap_dispatch+0x93>
  101cf5:	83 f8 24             	cmp    $0x24,%eax
  101cf8:	0f 87 bd 00 00 00    	ja     101dbb <trap_dispatch+0xfb>
  101cfe:	83 f8 20             	cmp    $0x20,%eax
  101d01:	74 0a                	je     101d0d <trap_dispatch+0x4d>
  101d03:	83 f8 21             	cmp    $0x21,%eax
  101d06:	74 71                	je     101d79 <trap_dispatch+0xb9>
  101d08:	e9 ae 00 00 00       	jmp    101dbb <trap_dispatch+0xfb>
         ...
         */
        ticks ++;
  101d0d:	a1 44 fe 10 00       	mov    0x10fe44,%eax
  101d12:	40                   	inc    %eax
  101d13:	a3 44 fe 10 00       	mov    %eax,0x10fe44
        if (ticks % TICK_NUM == 0) {
  101d18:	8b 0d 44 fe 10 00    	mov    0x10fe44,%ecx
  ...
  101d43:	0f 85 aa 00 00 00    	jne    101df3 <trap_dispatch+0x133>
            print_ticks();
  101d49:	e8 2c fb ff ff       	call   10187a <print_ticks>
        }
        break;
  101d4e:	e9 a0 00 00 00       	jmp    101df3 <trap_dispatch+0x133>
    case IRQ_OFFSET + IRQ_COM1:
        c = cons_getc();
  101d53:	e8 d8 f8 ff ff       	call   101630 <cons_getc>
  101d58:	88 45 f7             	mov    %al,-0x9(%ebp)
        cprintf("serial [%03d] %c\n", c, c);
  101d5b:	0f be 55 f7          	movsbl -0x9(%ebp),%edx
  101d5f:	0f be 45 f7          	movsbl -0x9(%ebp),%eax
  101d63:	89 54 24 08          	mov    %edx,0x8(%esp)
  101d67:	89 44 24 04          	mov    %eax,0x4(%esp)
  101d6b:	c7 04 24 34 3a 10 00 	movl   $0x103a34,(%esp)
  101d72:	e8 a9 e5 ff ff       	call   100320 <cprintf>
        break;
  101d77:	eb 7b                	jmp    101df4 <trap_dispatch+0x134>
    case IRQ_OFFSET + IRQ_KBD:
        c = cons_getc();
  101d79:	e8 b2 f8 ff ff       	call   101630 <cons_getc>
  101d7e:	88 45 f7             	mov    %al,-0x9(%ebp)
        cprintf("kbd [%03d] %c\n", c, c);
  101d81:	0f be 55 f7          	movsbl -0x9(%ebp),%edx
  101d85:	0f be 45 f7          	movsbl -0x9(%ebp),%eax
  101d89:	89 54 24 08          	mov    %edx,0x8(%esp)
  101d8d:	89 44 24 04          	mov    %eax,0x4(%esp)
  101d91:	c7 04 24 46 3a 10 00 	movl   $0x103a46,(%esp)
  101d98:	e8 83 e5 ff ff       	call   100320 <cprintf>
        break;
  101d9d:	eb 55                	jmp    101df4 <trap_dispatch+0x134>
    //LAB1 CHALLENGE 1 : YOUR CODE you should modify below codes.
    case T_SWITCH_TOU:
    case T_SWITCH_TOK:
        panic("T_SWITCH_** ??\n");
  101d9f:	c7 44 24 08 55 3a 10 	movl   $0x103a55,0x8(%esp)
  101da6:	00 
  101da7:	c7 44 24 04 ad 00 00 	movl   $0xad,0x4(%esp)
  101dae:	00 
  101daf:	c7 04 24 65 3a 10 00 	movl   $0x103a65,(%esp)
  101db6:	e8 ea ee ff ff       	call   100ca5 <__panic>
  ...
  101dbe:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
  101dc2:	83 e0 03             	and    $0x3,%eax
  101dc5:	85 c0                	test   %eax,%eax
  101dc7:	75 2b                	jne    101df4 <trap_dispatch+0x134>
            print_trapframe(tf);
  101dc9:	8b 45 08             	mov    0x8(%ebp),%eax
  101dcc:	89 04 24             	mov    %eax,(%esp)
  101dcf:	e8 7f fc ff ff       	call   101a53 <print_trapframe>
            panic("unexpected trap in kernel.\n");
  101dd4:	c7 44 24 08 76 3a 10 	movl   $0x103a76,0x8(%esp)
  101ddb:	00 
  101ddc:	c7 44 24 04 b7 00 00 	movl   $0xb7,0x4(%esp)
  101de3:	00 
  101de4:	c7 04 24 65 3a 10 00 	movl   $0x103a65,(%esp)
  101deb:	e8 b5 ee ff ff       	call   100ca5 <__panic>
        break;
  101df0:	90                   	nop
  101df1:	eb 01                	jmp    101df4 <trap_dispatch+0x134>
        break;
  101df3:	90                   	nop
        }
    }
...
trap(struct trapframe *tf) {
  ...
  101e05:	e8 b6 fe ff ff       	call   101cc0 <trap_dispatch>
}
  101e0a:	90                   	nop
  101e0b:	89 ec                	mov    %ebp,%esp
  101e0d:	5d                   	pop    %ebp
  101e0e:	c3                   	ret    
...
__alltraps:
  ...
  101e1f:	54                   	push   %esp
    ...
    call trap
  101e20:	e8 d4 ff ff ff       	call   101df9 <trap>
...
gdt_init(void) {
  ...
  1028dc:	83 ec 14             	sub    $0x14,%esp
    // Setup a TSS so that we can get the right stack when we trap from
    // user to the kernel. But not safe here, it's only a temporary value,
    // it will be set to KSTACKTOP in lab2.
    ts.ts_esp0 = (uint32_t)&stack0 + sizeof(stack0);
  1028df:	b8 a0 08 11 00       	mov    $0x1108a0,%eax
  1028e4:	05 00 04 00 00       	add    $0x400,%eax
  1028e9:	a3 a4 0c 11 00       	mov    %eax,0x110ca4
    ts.ts_ss0 = KERNEL_DS;
  1028ee:	66 c7 05 a8 0c 11 00 	movw   $0x10,0x110ca8
  1028f5:	10 00 
  ...
  1028fe:	68 00 
  102900:	b8 a0 0c 11 00       	mov    $0x110ca0,%eax
  102905:	0f b7 c0             	movzwl %ax,%eax
  102908:	66 a3 0a fa 10 00    	mov    %ax,0x10fa0a
  10290e:	b8 a0 0c 11 00       	mov    $0x110ca0,%eax
  102913:	c1 e8 10             	shr    $0x10,%eax
  102916:	a2 0c fa 10 00       	mov    %al,0x10fa0c
  10291b:	0f b6 05 0d fa 10 00 	movzbl 0x10fa0d,%eax
  102922:	24 f0                	and    $0xf0,%al
  102924:	0c 09                	or     $0x9,%al
  102926:	a2 0d fa 10 00       	mov    %al,0x10fa0d
  10292b:	0f b6 05 0d fa 10 00 	movzbl 0x10fa0d,%eax
  102932:	0c 10                	or     $0x10,%al
  102934:	a2 0d fa 10 00       	mov    %al,0x10fa0d
  102939:	0f b6 05 0d fa 10 00 	movzbl 0x10fa0d,%eax
  102940:	24 9f                	and    $0x9f,%al
  102942:	a2 0d fa 10 00       	mov    %al,0x10fa0d
  102947:	0f b6 05 0d fa 10 00 	movzbl 0x10fa0d,%eax
  10294e:	0c 80                	or     $0x80,%al
  102950:	a2 0d fa 10 00       	mov    %al,0x10fa0d
  102955:	0f b6 05 0e fa 10 00 	movzbl 0x10fa0e,%eax
  10295c:	24 f0                	and    $0xf0,%al
  10295e:	a2 0e fa 10 00       	mov    %al,0x10fa0e
  102963:	0f b6 05 0e fa 10 00 	movzbl 0x10fa0e,%eax
  10296a:	24 ef                	and    $0xef,%al
  10296c:	a2 0e fa 10 00       	mov    %al,0x10fa0e
  102971:	0f b6 05 0e fa 10 00 	movzbl 0x10fa0e,%eax
  102978:	24 df                	and    $0xdf,%al
  10297a:	a2 0e fa 10 00       	mov    %al,0x10fa0e
  10297f:	0f b6 05 0e fa 10 00 	movzbl 0x10fa0e,%eax
  102986:	0c 40                	or     $0x40,%al
  102988:	a2 0e fa 10 00       	mov    %al,0x10fa0e
  10298d:	0f b6 05 0e fa 10 00 	movzbl 0x10fa0e,%eax
  102994:	24 7f                	and    $0x7f,%al
  102996:	a2 0e fa 10 00       	mov    %al,0x10fa0e
  10299b:	b8 a0 0c 11 00       	mov    $0x110ca0,%eax
  1029a0:	c1 e8 18             	shr    $0x18,%eax
  1029a3:	a2 0f fa 10 00       	mov    %al,0x10fa0f
    gdt[SEG_TSS].sd_s = 0;
  1029a8:	0f b6 05 0d fa 10 00 	movzbl 0x10fa0d,%eax
  1029af:	24 ef                	and    $0xef,%al
  1029b1:	a2 0d fa 10 00       	mov    %al,0x10fa0d

    // reload all segment registers
    lgdt(&gdt_pd);
  1029b6:	c7 04 24 10 fa 10 00 	movl   $0x10fa10,(%esp)
  1029bd:	e8 e1 fe ff ff       	call   1028a3 <lgdt>
  1029c2:	66 c7 45 fe 28 00    	movw   $0x28,-0x2(%ebp)

static inline void
ltr(uint16_t sel) {
    asm volatile ("ltr %0" :: "r" (sel));
  1029c8:	0f b7 45 fe          	movzwl -0x2(%ebp),%eax
  1029cc:	0f 00 d8             	ltr    %ax
}
  1029cf:	90                   	nop
...
pmm_init(void) {
  ...
  1029d6:	89 e5                	mov    %esp,%ebp
    gdt_init();
  1029d8:	e8 fc fe ff ff       	call   1028d9 <gdt_init>
}
  1029dd:	90                   	nop
  1029de:	5d                   	pop    %ebp
  1029df:	c3                   	ret    
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  102a61:	8b 4d d4             	mov    -0x2c(%ebp),%ecx
  102a64:	39 45 d0             	cmp    %eax,-0x30(%ebp)
  102a67:	19 d1                	sbb    %edx,%ecx
  102a69:	72 4c                	jb     102ab7 <printnum+0xd7>
        printnum(putch, putdat, result, base, width - 1, padc);
  102a6b:	8b 45 1c             	mov    0x1c(%ebp),%eax
  102a6e:	8d 50 ff             	lea    -0x1(%eax),%edx
  102a71:	8b 45 20             	mov    0x20(%ebp),%eax
  102a74:	89 44 24 18          	mov    %eax,0x18(%esp)
  102a78:	89 54 24 14          	mov    %edx,0x14(%esp)
  102a7c:	8b 45 18             	mov    0x18(%ebp),%eax
  102a7f:	89 44 24 10          	mov    %eax,0x10(%esp)
  102a83:	8b 45 e8             	mov    -0x18(%ebp),%eax
  102a86:	8b 55 ec             	mov    -0x14(%ebp),%edx
  102a89:	89 44 24 08          	mov    %eax,0x8(%esp)
  102a8d:	89 54 24 0c          	mov    %edx,0xc(%esp)
  102a91:	8b 45 0c             	mov    0xc(%ebp),%eax
  102a94:	89 44 24 04          	mov    %eax,0x4(%esp)
  102a98:	8b 45 08             	mov    0x8(%ebp),%eax
  102a9b:	89 04 24             	mov    %eax,(%esp)
  102a9e:	e8 3d ff ff ff       	call   1029e0 <printnum>
  102aa3:	eb 1b                	jmp    102ac0 <printnum+0xe0>
    } else {
        // print any needed pad characters before first digit
        while (-- width > 0)
            putch(padc, putdat);
  102aa5:	8b 45 0c             	mov    0xc(%ebp),%eax
  102aa8:	89 44 24 04          	mov    %eax,0x4(%esp)
  102aac:	8b 45 20             	mov    0x20(%ebp),%eax
  102aaf:	89 04 24             	mov    %eax,(%esp)
  102ab2:	8b 45 08             	mov    0x8(%ebp),%eax
  102ab5:	ff d0                	call   *%eax
        while (-- width > 0)
  102ab7:	ff 4d 1c             	decl   0x1c(%ebp)
  102aba:	83 7d 1c 00          	cmpl   $0x0,0x1c(%ebp)
  102abe:	7f e5                	jg     102aa5 <printnum+0xc5>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
  102ac0:	8b 45 d8             	mov    -0x28(%ebp),%eax
  102ac3:	05 b0 3c 10 00       	add    $0x103cb0,%eax
  102ac8:	0f b6 00             	movzbl (%eax),%eax
  102acb:	0f be c0             	movsbl %al,%eax
  102ace:	8b 55 0c             	mov    0xc(%ebp),%edx
  102ad1:	89 54 24 04          	mov    %edx,0x4(%esp)
  102ad5:	89 04 24             	mov    %eax,(%esp)
  102ad8:	8b 45 08             	mov    0x8(%ebp),%eax
  102adb:	ff d0                	call   *%eax
}
  102add:	90                   	nop
  102ade:	89 ec                	mov    %ebp,%esp
  102ae0:	5d                   	pop    %ebp
  102ae1:	c3                   	ret    
...
getuint(va_list *ap, int lflag) {
  ...
  102ae3:	89 e5                	mov    %esp,%ebp
    if (lflag >= 2) {
  102ae5:	83 7d 0c 01          	cmpl   $0x1,0xc(%ebp)
  102ae9:	7e 14                	jle    102aff <getuint+0x1d>
        return va_arg(*ap, unsigned long long);
  102aeb:	8b 45 08             	mov    0x8(%ebp),%eax
  102aee:	8b 00                	mov    (%eax),%eax
  102af0:	8d 48 08             	lea    0x8(%eax),%ecx
  102af3:	8b 55 08             	mov    0x8(%ebp),%edx
  102af6:	89 0a                	mov    %ecx,(%edx)
  102af8:	8b 50 04             	mov    0x4(%eax),%edx
  102afb:	8b 00                	mov    (%eax),%eax
  102afd:	eb 30                	jmp    102b2f <getuint+0x4d>
    }
    else if (lflag) {
  102aff:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
  102b03:	74 16                	je     102b1b <getuint+0x39>
        return va_arg(*ap, unsigned long);
  102b05:	8b 45 08             	mov    0x8(%ebp),%eax
  102b08:	8b 00                	mov    (%eax),%eax
  102b0a:	8d 48 04             	lea    0x4(%eax),%ecx
  102b0d:	8b 55 08             	mov    0x8(%ebp),%edx
  102b10:	89 0a                	mov    %ecx,(%edx)
  102b12:	8b 00                	mov    (%eax),%eax
  102b14:	ba 00 00 00 00       	mov    $0x0,%edx
  102b19:	eb 14                	jmp    102b2f <getuint+0x4d>
    }
    else {
        return va_arg(*ap, unsigned int);
  102b1b:	8b 45 08             	mov    0x8(%ebp),%eax
  102b1e:	8b 00                	mov    (%eax),%eax
  102b20:	8d 48 04             	lea    0x4(%eax),%ecx
  102b23:	8b 55 08             	mov    0x8(%ebp),%edx
  102b26:	89 0a                	mov    %ecx,(%edx)
  102b28:	8b 00                	mov    (%eax),%eax
  102b2a:	ba 00 00 00 00       	mov    $0x0,%edx
    }
}
  102b2f:	5d                   	pop    %ebp
  102b30:	c3                   	ret    
...
getint(va_list *ap, int lflag) {
  ...
  102b32:	89 e5                	mov    %esp,%ebp
    if (lflag >= 2) {
  102b34:	83 7d 0c 01          	cmpl   $0x1,0xc(%ebp)
  102b38:	7e 14                	jle    102b4e <getint+0x1d>
        return va_arg(*ap, long long);
  102b3a:	8b 45 08             	mov    0x8(%ebp),%eax
  102b3d:	8b 00                	mov    (%eax),%eax
  102b3f:	8d 48 08             	lea    0x8(%eax),%ecx
  102b42:	8b 55 08             	mov    0x8(%ebp),%edx
  102b45:	89 0a                	mov    %ecx,(%edx)
  102b47:	8b 50 04             	mov    0x4(%eax),%edx
  102b4a:	8b 00                	mov    (%eax),%eax
  102b4c:	eb 28                	jmp    102b76 <getint+0x45>
    }
    else if (lflag) {
  102b4e:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
  102b52:	74 12                	je     102b66 <getint+0x35>
        return va_arg(*ap, long);
  102b54:	8b 45 08             	mov    0x8(%ebp),%eax
  102b57:	8b 00                	mov    (%eax),%eax
  102b59:	8d 48 04             	lea    0x4(%eax),%ecx
  102b5c:	8b 55 08             	mov    0x8(%ebp),%edx
  102b5f:	89 0a                	mov    %ecx,(%edx)
  102b61:	8b 00                	mov    (%eax),%eax
  102b63:	99                   	cltd   
  102b64:	eb 10                	jmp    102b76 <getint+0x45>
    }
    else {
        return va_arg(*ap, int);
  102b66:	8b 45 08             	mov    0x8(%ebp),%eax
  102b69:	8b 00                	mov    (%eax),%eax
  102b6b:	8d 48 04             	lea    0x4(%eax),%ecx
  102b6e:	8b 55 08             	mov    0x8(%ebp),%edx
  102b71:	89 0a                	mov    %ecx,(%edx)
  102b73:	8b 00                	mov    (%eax),%eax
  102b75:	99                   	cltd   
    }
}
  102b76:	5d                   	pop    %ebp
...
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
  ...
  102b87:	89 44 24 0c          	mov    %eax,0xc(%esp)
  102b8b:	8b 45 10             	mov    0x10(%ebp),%eax
  102b8e:	89 44 24 08          	mov    %eax,0x8(%esp)
  102b92:	8b 45 0c             	mov    0xc(%ebp),%eax
  102b95:	89 44 24 04          	mov    %eax,0x4(%esp)
  102b99:	8b 45 08             	mov    0x8(%ebp),%eax
  102b9c:	89 04 24             	mov    %eax,(%esp)
  102b9f:	e8 05 00 00 00       	call   102ba9 <vprintfmt>
    va_end(ap);
}
  102ba4:	90                   	nop
  102ba5:	89 ec                	mov    %ebp,%esp
  102ba7:	5d                   	pop    %ebp
  102ba8:	c3                   	ret    
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  102bb1:	eb 17                	jmp    102bca <vprintfmt+0x21>
            if (ch == '\0') {
  102bb3:	85 db                	test   %ebx,%ebx
  102bb5:	0f 84 bf 03 00 00    	je     102f7a <vprintfmt+0x3d1>
                return;
            }
            putch(ch, putdat);
  102bbb:	8b 45 0c             	mov    0xc(%ebp),%eax
  102bbe:	89 44 24 04          	mov    %eax,0x4(%esp)
  102bc2:	89 1c 24             	mov    %ebx,(%esp)
  102bc5:	8b 45 08             	mov    0x8(%ebp),%eax
  102bc8:	ff d0                	call   *%eax
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  102bca:	8b 45 10             	mov    0x10(%ebp),%eax
  102bcd:	8d 50 01             	lea    0x1(%eax),%edx
  102bd0:	89 55 10             	mov    %edx,0x10(%ebp)
  102bd3:	0f b6 00             	movzbl (%eax),%eax
  102bd6:	0f b6 d8             	movzbl %al,%ebx
  102bd9:	83 fb 25             	cmp    $0x25,%ebx
  102bdc:	75 d5                	jne    102bb3 <vprintfmt+0xa>
        }

        // Process a %-escape sequence
        char padc = ' ';
  102bde:	c6 45 db 20          	movb   $0x20,-0x25(%ebp)
        width = precision = -1;
  102be2:	c7 45 e4 ff ff ff ff 	movl   $0xffffffff,-0x1c(%ebp)
  102be9:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  102bec:	89 45 e8             	mov    %eax,-0x18(%ebp)
        lflag = altflag = 0;
  102bef:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%ebp)
  102bf6:	8b 45 dc             	mov    -0x24(%ebp),%eax
  102bf9:	89 45 e0             	mov    %eax,-0x20(%ebp)

    reswitch:
        switch (ch = *(unsigned char *)fmt ++) {
  102bfc:	8b 45 10             	mov    0x10(%ebp),%eax
  102bff:	8d 50 01             	lea    0x1(%eax),%edx
  102c02:	89 55 10             	mov    %edx,0x10(%ebp)
  102c05:	0f b6 00             	movzbl (%eax),%eax
  102c08:	0f b6 d8             	movzbl %al,%ebx
  102c0b:	8d 43 dd             	lea    -0x23(%ebx),%eax
  102c0e:	83 f8 55             	cmp    $0x55,%eax
  102c11:	0f 87 37 03 00 00    	ja     102f4e <vprintfmt+0x3a5>
  102c17:	8b 04 85 d4 3c 10 00 	mov    0x103cd4(,%eax,4),%eax
  102c1e:	ff e0                	jmp    *%eax

        // flag to pad on the right
        case '-':
            padc = '-';
  102c20:	c6 45 db 2d          	movb   $0x2d,-0x25(%ebp)
            goto reswitch;
  102c24:	eb d6                	jmp    102bfc <vprintfmt+0x53>

        // flag to pad with 0's instead of spaces
        case '0':
            padc = '0';
  102c26:	c6 45 db 30          	movb   $0x30,-0x25(%ebp)
            goto reswitch;
  102c2a:	eb d0                	jmp    102bfc <vprintfmt+0x53>
  ...
  102c33:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  102c36:	89 d0                	mov    %edx,%eax
  102c38:	c1 e0 02             	shl    $0x2,%eax
  102c3b:	01 d0                	add    %edx,%eax
  102c3d:	01 c0                	add    %eax,%eax
  102c3f:	01 d8                	add    %ebx,%eax
  102c41:	83 e8 30             	sub    $0x30,%eax
  102c44:	89 45 e4             	mov    %eax,-0x1c(%ebp)
                ch = *fmt;
  102c47:	8b 45 10             	mov    0x10(%ebp),%eax
  102c4a:	0f b6 00             	movzbl (%eax),%eax
  102c4d:	0f be d8             	movsbl %al,%ebx
                if (ch < '0' || ch > '9') {
  102c50:	83 fb 2f             	cmp    $0x2f,%ebx
  102c53:	7e 38                	jle    102c8d <vprintfmt+0xe4>
  102c55:	83 fb 39             	cmp    $0x39,%ebx
  102c58:	7f 33                	jg     102c8d <vprintfmt+0xe4>
            for (precision = 0; ; ++ fmt) {
  102c5a:	ff 45 10             	incl   0x10(%ebp)
                precision = precision * 10 + ch - '0';
  102c5d:	eb d4                	jmp    102c33 <vprintfmt+0x8a>
                }
            }
  ...
  102c5f:	8b 45 14             	mov    0x14(%ebp),%eax
  102c62:	8d 50 04             	lea    0x4(%eax),%edx
  102c65:	89 55 14             	mov    %edx,0x14(%ebp)
  102c68:	8b 00                	mov    (%eax),%eax
  102c6a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            goto process_precision;
  102c6d:	eb 1f                	jmp    102c8e <vprintfmt+0xe5>

        case '.':
            if (width < 0)
  102c6f:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
  102c73:	79 87                	jns    102bfc <vprintfmt+0x53>
                width = 0;
  102c75:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
            goto reswitch;
  102c7c:	e9 7b ff ff ff       	jmp    102bfc <vprintfmt+0x53>

        case '#':
            altflag = 1;
  102c81:	c7 45 dc 01 00 00 00 	movl   $0x1,-0x24(%ebp)
            goto reswitch;
  102c88:	e9 6f ff ff ff       	jmp    102bfc <vprintfmt+0x53>
            goto process_precision;
  102c8d:	90                   	nop

        process_precision:
            if (width < 0)
  102c8e:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
  102c92:	0f 89 64 ff ff ff    	jns    102bfc <vprintfmt+0x53>
                width = precision, precision = -1;
  102c98:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  102c9b:	89 45 e8             	mov    %eax,-0x18(%ebp)
  102c9e:	c7 45 e4 ff ff ff ff 	movl   $0xffffffff,-0x1c(%ebp)
            goto reswitch;
  102ca5:	e9 52 ff ff ff       	jmp    102bfc <vprintfmt+0x53>

        // long flag (doubled for long long)
        case 'l':
            lflag ++;
  102caa:	ff 45 e0             	incl   -0x20(%ebp)
            goto reswitch;
  102cad:	e9 4a ff ff ff       	jmp    102bfc <vprintfmt+0x53>

        // character
        case 'c':
            putch(va_arg(ap, int), putdat);
  102cb2:	8b 45 14             	mov    0x14(%ebp),%eax
  102cb5:	8d 50 04             	lea    0x4(%eax),%edx
  102cb8:	89 55 14             	mov    %edx,0x14(%ebp)
  102cbb:	8b 00                	mov    (%eax),%eax
  102cbd:	8b 55 0c             	mov    0xc(%ebp),%edx
  102cc0:	89 54 24 04          	mov    %edx,0x4(%esp)
  102cc4:	89 04 24             	mov    %eax,(%esp)
  102cc7:	8b 45 08             	mov    0x8(%ebp),%eax
  102cca:	ff d0                	call   *%eax
            break;
  102ccc:	e9 a4 02 00 00       	jmp    102f75 <vprintfmt+0x3cc>

        // error message
        case 'e':
            err = va_arg(ap, int);
  102cd1:	8b 45 14             	mov    0x14(%ebp),%eax
  102cd4:	8d 50 04             	lea    0x4(%eax),%edx
  102cd7:	89 55 14             	mov    %edx,0x14(%ebp)
  102cda:	8b 18                	mov    (%eax),%ebx
            if (err < 0) {
  102cdc:	85 db                	test   %ebx,%ebx
  102cde:	79 02                	jns    102ce2 <vprintfmt+0x139>
                err = -err;
  102ce0:	f7 db                	neg    %ebx
            }
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
  102ce2:	83 fb 06             	cmp    $0x6,%ebx
  102ce5:	7f 0b                	jg     102cf2 <vprintfmt+0x149>
  102ce7:	8b 34 9d 94 3c 10 00 	mov    0x103c94(,%ebx,4),%esi
  102cee:	85 f6                	test   %esi,%esi
  102cf0:	75 23                	jne    102d15 <vprintfmt+0x16c>
                printfmt(putch, putdat, "error %d", err);
  102cf2:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
  102cf6:	c7 44 24 08 c1 3c 10 	movl   $0x103cc1,0x8(%esp)
  102cfd:	00 
  102cfe:	8b 45 0c             	mov    0xc(%ebp),%eax
  102d01:	89 44 24 04          	mov    %eax,0x4(%esp)
  102d05:	8b 45 08             	mov    0x8(%ebp),%eax
  102d08:	89 04 24             	mov    %eax,(%esp)
  102d0b:	e8 68 fe ff ff       	call   102b78 <printfmt>
            }
            else {
                printfmt(putch, putdat, "%s", p);
            }
            break;
  102d10:	e9 60 02 00 00       	jmp    102f75 <vprintfmt+0x3cc>
                printfmt(putch, putdat, "%s", p);
  102d15:	89 74 24 0c          	mov    %esi,0xc(%esp)
  102d19:	c7 44 24 08 ca 3c 10 	movl   $0x103cca,0x8(%esp)
  102d20:	00 
  ...
  102d2e:	e8 45 fe ff ff       	call   102b78 <printfmt>
            break;
  102d33:	e9 3d 02 00 00       	jmp    102f75 <vprintfmt+0x3cc>

        // string
        case 's':
            if ((p = va_arg(ap, char *)) == NULL) {
  102d38:	8b 45 14             	mov    0x14(%ebp),%eax
  102d3b:	8d 50 04             	lea    0x4(%eax),%edx
  102d3e:	89 55 14             	mov    %edx,0x14(%ebp)
  102d41:	8b 30                	mov    (%eax),%esi
  102d43:	85 f6                	test   %esi,%esi
  102d45:	75 05                	jne    102d4c <vprintfmt+0x1a3>
                p = "(null)";
  102d47:	be cd 3c 10 00       	mov    $0x103ccd,%esi
            }
            if (width > 0 && padc != '-') {
  102d4c:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
  102d50:	7e 76                	jle    102dc8 <vprintfmt+0x21f>
  102d52:	80 7d db 2d          	cmpb   $0x2d,-0x25(%ebp)
  102d56:	74 70                	je     102dc8 <vprintfmt+0x21f>
                for (width -= strnlen(p, precision); width > 0; width --) {
  102d58:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  102d5b:	89 44 24 04          	mov    %eax,0x4(%esp)
  102d5f:	89 34 24             	mov    %esi,(%esp)
  102d62:	e8 16 03 00 00       	call   10307d <strnlen>
  102d67:	89 c2                	mov    %eax,%edx
  102d69:	8b 45 e8             	mov    -0x18(%ebp),%eax
  102d6c:	29 d0                	sub    %edx,%eax
  102d6e:	89 45 e8             	mov    %eax,-0x18(%ebp)
  102d71:	eb 16                	jmp    102d89 <vprintfmt+0x1e0>
                    putch(padc, putdat);
  102d73:	0f be 45 db          	movsbl -0x25(%ebp),%eax
  ...
  102d84:	ff d0                	call   *%eax
                for (width -= strnlen(p, precision); width > 0; width --) {
  102d86:	ff 4d e8             	decl   -0x18(%ebp)
  102d89:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
  102d8d:	7f e4                	jg     102d73 <vprintfmt+0x1ca>
                }
            }
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  102d8f:	eb 37                	jmp    102dc8 <vprintfmt+0x21f>
                if (altflag && (ch < ' ' || ch > '~')) {
  102d91:	83 7d dc 00          	cmpl   $0x0,-0x24(%ebp)
  102d95:	74 1f                	je     102db6 <vprintfmt+0x20d>
  102d97:	83 fb 1f             	cmp    $0x1f,%ebx
  102d9a:	7e 05                	jle    102da1 <vprintfmt+0x1f8>
  102d9c:	83 fb 7e             	cmp    $0x7e,%ebx
  102d9f:	7e 15                	jle    102db6 <vprintfmt+0x20d>
                    putch('?', putdat);
  102da1:	8b 45 0c             	mov    0xc(%ebp),%eax
  102da4:	89 44 24 04          	mov    %eax,0x4(%esp)
  102da8:	c7 04 24 3f 00 00 00 	movl   $0x3f,(%esp)
  102daf:	8b 45 08             	mov    0x8(%ebp),%eax
  102db2:	ff d0                	call   *%eax
  102db4:	eb 0f                	jmp    102dc5 <vprintfmt+0x21c>
                }
                else {
                    putch(ch, putdat);
  102db6:	8b 45 0c             	mov    0xc(%ebp),%eax
  102db9:	89 44 24 04          	mov    %eax,0x4(%esp)
  102dbd:	89 1c 24             	mov    %ebx,(%esp)
  102dc0:	8b 45 08             	mov    0x8(%ebp),%eax
  102dc3:	ff d0                	call   *%eax
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  102dc5:	ff 4d e8             	decl   -0x18(%ebp)
  102dc8:	89 f0                	mov    %esi,%eax
  102dca:	8d 70 01             	lea    0x1(%eax),%esi
  102dcd:	0f b6 00             	movzbl (%eax),%eax
  102dd0:	0f be d8             	movsbl %al,%ebx
  102dd3:	85 db                	test   %ebx,%ebx
  102dd5:	74 27                	je     102dfe <vprintfmt+0x255>
  102dd7:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
  102ddb:	78 b4                	js     102d91 <vprintfmt+0x1e8>
  102ddd:	ff 4d e4             	decl   -0x1c(%ebp)
  102de0:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
  102de4:	79 ab                	jns    102d91 <vprintfmt+0x1e8>
                }
            }
            for (; width > 0; width --) {
  102de6:	eb 16                	jmp    102dfe <vprintfmt+0x255>
                putch(' ', putdat);
  102de8:	8b 45 0c             	mov    0xc(%ebp),%eax
  102deb:	89 44 24 04          	mov    %eax,0x4(%esp)
  102def:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
  102df6:	8b 45 08             	mov    0x8(%ebp),%eax
  102df9:	ff d0                	call   *%eax
            for (; width > 0; width --) {
  102dfb:	ff 4d e8             	decl   -0x18(%ebp)
  102dfe:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
  102e02:	7f e4                	jg     102de8 <vprintfmt+0x23f>
            }
            break;
  102e04:	e9 6c 01 00 00       	jmp    102f75 <vprintfmt+0x3cc>
  ...
  102e16:	e8 16 fd ff ff       	call   102b31 <getint>
  102e1b:	89 45 f0             	mov    %eax,-0x10(%ebp)
  102e1e:	89 55 f4             	mov    %edx,-0xc(%ebp)
            if ((long long)num < 0) {
  102e21:	8b 45 f0             	mov    -0x10(%ebp),%eax
  102e24:	8b 55 f4             	mov    -0xc(%ebp),%edx
  102e27:	85 d2                	test   %edx,%edx
  102e29:	79 26                	jns    102e51 <vprintfmt+0x2a8>
                putch('-', putdat);
  102e2b:	8b 45 0c             	mov    0xc(%ebp),%eax
  102e2e:	89 44 24 04          	mov    %eax,0x4(%esp)
  102e32:	c7 04 24 2d 00 00 00 	movl   $0x2d,(%esp)
  102e39:	8b 45 08             	mov    0x8(%ebp),%eax
  102e3c:	ff d0                	call   *%eax
                num = -(long long)num;
  102e3e:	8b 45 f0             	mov    -0x10(%ebp),%eax
  102e41:	8b 55 f4             	mov    -0xc(%ebp),%edx
  102e44:	f7 d8                	neg    %eax
  102e46:	83 d2 00             	adc    $0x0,%edx
  102e49:	f7 da                	neg    %edx
  102e4b:	89 45 f0             	mov    %eax,-0x10(%ebp)
  102e4e:	89 55 f4             	mov    %edx,-0xc(%ebp)
            }
            base = 10;
  102e51:	c7 45 ec 0a 00 00 00 	movl   $0xa,-0x14(%ebp)
            goto number;
  102e58:	e9 a8 00 00 00       	jmp    102f05 <vprintfmt+0x35c>
  ...
  102e8e:	e8 4f fc ff ff       	call   102ae2 <getuint>
  102e93:	89 45 f0             	mov    %eax,-0x10(%ebp)
  102e96:	89 55 f4             	mov    %edx,-0xc(%ebp)
            base = 8;
  102e99:	c7 45 ec 08 00 00 00 	movl   $0x8,-0x14(%ebp)
            goto number;
  102ea0:	eb 63                	jmp    102f05 <vprintfmt+0x35c>
  ...
  102ea9:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
  102eb0:	8b 45 08             	mov    0x8(%ebp),%eax
  102eb3:	ff d0                	call   *%eax
            putch('x', putdat);
  102eb5:	8b 45 0c             	mov    0xc(%ebp),%eax
  102eb8:	89 44 24 04          	mov    %eax,0x4(%esp)
  102ebc:	c7 04 24 78 00 00 00 	movl   $0x78,(%esp)
  102ec3:	8b 45 08             	mov    0x8(%ebp),%eax
  102ec6:	ff d0                	call   *%eax
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
  102ec8:	8b 45 14             	mov    0x14(%ebp),%eax
  102ecb:	8d 50 04             	lea    0x4(%eax),%edx
  102ece:	89 55 14             	mov    %edx,0x14(%ebp)
  102ed1:	8b 00                	mov    (%eax),%eax
  102ed3:	89 45 f0             	mov    %eax,-0x10(%ebp)
  102ed6:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
            base = 16;
  102edd:	c7 45 ec 10 00 00 00 	movl   $0x10,-0x14(%ebp)
            goto number;
  102ee4:	eb 1f                	jmp    102f05 <vprintfmt+0x35c>

        // (unsigned) hexadecimal
        case 'x':
            num = getuint(&ap, lflag);
  102ee6:	8b 45 e0             	mov    -0x20(%ebp),%eax
  102ee9:	89 44 24 04          	mov    %eax,0x4(%esp)
  102eed:	8d 45 14             	lea    0x14(%ebp),%eax
  102ef0:	89 04 24             	mov    %eax,(%esp)
  102ef3:	e8 ea fb ff ff       	call   102ae2 <getuint>
  102ef8:	89 45 f0             	mov    %eax,-0x10(%ebp)
  102efb:	89 55 f4             	mov    %edx,-0xc(%ebp)
            base = 16;
  102efe:	c7 45 ec 10 00 00 00 	movl   $0x10,-0x14(%ebp)
        number:
            printnum(putch, putdat, num, base, width, padc);
  102f05:	0f be 55 db          	movsbl -0x25(%ebp),%edx
  102f09:	8b 45 ec             	mov    -0x14(%ebp),%eax
  102f0c:	89 54 24 18          	mov    %edx,0x18(%esp)
  102f10:	8b 55 e8             	mov    -0x18(%ebp),%edx
  102f13:	89 54 24 14          	mov    %edx,0x14(%esp)
  102f17:	89 44 24 10          	mov    %eax,0x10(%esp)
  102f1b:	8b 45 f0             	mov    -0x10(%ebp),%eax
  102f1e:	8b 55 f4             	mov    -0xc(%ebp),%edx
  102f21:	89 44 24 08          	mov    %eax,0x8(%esp)
  102f25:	89 54 24 0c          	mov    %edx,0xc(%esp)
  ...
  102f36:	e8 a5 fa ff ff       	call   1029e0 <printnum>
            break;
  102f3b:	eb 38                	jmp    102f75 <vprintfmt+0x3cc>
  ...
  102f4a:	ff d0                	call   *%eax
            break;
  102f4c:	eb 27                	jmp    102f75 <vprintfmt+0x3cc>
  ...
  102f55:	c7 04 24 25 00 00 00 	movl   $0x25,(%esp)
  102f5c:	8b 45 08             	mov    0x8(%ebp),%eax
  102f5f:	ff d0                	call   *%eax
            for (fmt --; fmt[-1] != '%'; fmt --)
  102f61:	ff 4d 10             	decl   0x10(%ebp)
  102f64:	eb 03                	jmp    102f69 <vprintfmt+0x3c0>
  102f66:	ff 4d 10             	decl   0x10(%ebp)
  102f69:	8b 45 10             	mov    0x10(%ebp),%eax
  102f6c:	48                   	dec    %eax
  102f6d:	0f b6 00             	movzbl (%eax),%eax
  102f70:	3c 25                	cmp    $0x25,%al
  102f72:	75 f2                	jne    102f66 <vprintfmt+0x3bd>
                /* do nothing */;
            break;
  102f74:	90                   	nop
    while (1) {
  102f75:	e9 37 fc ff ff       	jmp    102bb1 <vprintfmt+0x8>
                return;
  102f7a:	90                   	nop
        }
    }
}
  102f7b:	83 c4 40             	add    $0x40,%esp
  102f7e:	5b                   	pop    %ebx
  102f7f:	5e                   	pop    %esi
  102f80:	5d                   	pop    %ebp
  102f81:	c3                   	ret    

00102f82 <sprintputch>:
...
sprintputch(int ch, struct sprintbuf *b) {
  ...
  102f88:	8b 40 08             	mov    0x8(%eax),%eax
  102f8b:	8d 50 01             	lea    0x1(%eax),%edx
  102f8e:	8b 45 0c             	mov    0xc(%ebp),%eax
  102f91:	89 50 08             	mov    %edx,0x8(%eax)
    if (b->buf < b->ebuf) {
  102f94:	8b 45 0c             	mov    0xc(%ebp),%eax
  102f97:	8b 10                	mov    (%eax),%edx
  102f99:	8b 45 0c             	mov    0xc(%ebp),%eax
  102f9c:	8b 40 04             	mov    0x4(%eax),%eax
  102f9f:	39 c2                	cmp    %eax,%edx
  102fa1:	73 12                	jae    102fb5 <sprintputch+0x33>
        *b->buf ++ = ch;
  102fa3:	8b 45 0c             	mov    0xc(%ebp),%eax
  102fa6:	8b 00                	mov    (%eax),%eax
  102fa8:	8d 48 01             	lea    0x1(%eax),%ecx
  102fab:	8b 55 0c             	mov    0xc(%ebp),%edx
  102fae:	89 0a                	mov    %ecx,(%edx)
  102fb0:	8b 55 08             	mov    0x8(%ebp),%edx
  102fb3:	88 10                	mov    %dl,(%eax)
    }
}
  102fb5:	90                   	nop
  102fb6:	5d                   	pop    %ebp
...
snprintf(char *str, size_t size, const char *fmt, ...) {
  ...
  102fbb:	83 ec 28             	sub    $0x28,%esp
    va_list ap;
    int cnt;
    va_start(ap, fmt);
  102fbe:	8d 45 14             	lea    0x14(%ebp),%eax
  102fc1:	89 45 f0             	mov    %eax,-0x10(%ebp)
    cnt = vsnprintf(str, size, fmt, ap);
  102fc4:	8b 45 f0             	mov    -0x10(%ebp),%eax
  102fc7:	89 44 24 0c          	mov    %eax,0xc(%esp)
  102fcb:	8b 45 10             	mov    0x10(%ebp),%eax
  102fce:	89 44 24 08          	mov    %eax,0x8(%esp)
  ...
  102fdf:	e8 0a 00 00 00       	call   102fee <vsnprintf>
  102fe4:	89 45 f4             	mov    %eax,-0xc(%ebp)
    va_end(ap);
    return cnt;
  102fe7:	8b 45 f4             	mov    -0xc(%ebp),%eax
}
  102fea:	89 ec                	mov    %ebp,%esp
  102fec:	5d                   	pop    %ebp
  102fed:	c3                   	ret    
...
vsnprintf(char *str, size_t size, const char *fmt, va_list ap) {
  102fee:	55                   	push   %ebp
  102fef:	89 e5                	mov    %esp,%ebp
  102ff1:	83 ec 28             	sub    $0x28,%esp
  ...
  103003:	01 d0                	add    %edx,%eax
  103005:	89 45 f0             	mov    %eax,-0x10(%ebp)
  103008:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if (str == NULL || b.buf > b.ebuf) {
  10300f:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
  103013:	74 0a                	je     10301f <vsnprintf+0x31>
  103015:	8b 55 ec             	mov    -0x14(%ebp),%edx
  103018:	8b 45 f0             	mov    -0x10(%ebp),%eax
  10301b:	39 c2                	cmp    %eax,%edx
  10301d:	76 07                	jbe    103026 <vsnprintf+0x38>
        return -E_INVAL;
  10301f:	b8 fd ff ff ff       	mov    $0xfffffffd,%eax
  103024:	eb 2a                	jmp    103050 <vsnprintf+0x62>
    }
    // print the string to the buffer
    vprintfmt((void*)sprintputch, &b, fmt, ap);
  103026:	8b 45 14             	mov    0x14(%ebp),%eax
  103029:	89 44 24 0c          	mov    %eax,0xc(%esp)
  10302d:	8b 45 10             	mov    0x10(%ebp),%eax
  103030:	89 44 24 08          	mov    %eax,0x8(%esp)
  103034:	8d 45 ec             	lea    -0x14(%ebp),%eax
  103037:	89 44 24 04          	mov    %eax,0x4(%esp)
  10303b:	c7 04 24 82 2f 10 00 	movl   $0x102f82,(%esp)
  103042:	e8 62 fb ff ff       	call   102ba9 <vprintfmt>
    // null terminate the buffer
    *b.buf = '\0';
  103047:	8b 45 ec             	mov    -0x14(%ebp),%eax
  10304a:	c6 00 00             	movb   $0x0,(%eax)
    return b.cnt;
  10304d:	8b 45 f4             	mov    -0xc(%ebp),%eax
}
  103050:	89 ec                	mov    %ebp,%esp
  103052:	5d                   	pop    %ebp
  103053:	c3                   	ret    
...
strlen(const char *s) {
  ...
  103057:	83 ec 10             	sub    $0x10,%esp
    size_t cnt = 0;
  10305a:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
    while (*s ++ != '\0') {
  103061:	eb 03                	jmp    103066 <strlen+0x12>
        cnt ++;
  103063:	ff 45 fc             	incl   -0x4(%ebp)
    while (*s ++ != '\0') {
  103066:	8b 45 08             	mov    0x8(%ebp),%eax
  103069:	8d 50 01             	lea    0x1(%eax),%edx
  10306c:	89 55 08             	mov    %edx,0x8(%ebp)
  10306f:	0f b6 00             	movzbl (%eax),%eax
  103072:	84 c0                	test   %al,%al
  103074:	75 ed                	jne    103063 <strlen+0xf>
    }
    return cnt;
  103076:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
  103079:	89 ec                	mov    %ebp,%esp
  10307b:	5d                   	pop    %ebp
  10307c:	c3                   	ret    
...
strnlen(const char *s, size_t len) {
  ...
  103080:	83 ec 10             	sub    $0x10,%esp
    size_t cnt = 0;
  103083:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
    while (cnt < len && *s ++ != '\0') {
  10308a:	eb 03                	jmp    10308f <strnlen+0x12>
        cnt ++;
  10308c:	ff 45 fc             	incl   -0x4(%ebp)
    while (cnt < len && *s ++ != '\0') {
  10308f:	8b 45 fc             	mov    -0x4(%ebp),%eax
  103092:	3b 45 0c             	cmp    0xc(%ebp),%eax
  103095:	73 10                	jae    1030a7 <strnlen+0x2a>
  103097:	8b 45 08             	mov    0x8(%ebp),%eax
  10309a:	8d 50 01             	lea    0x1(%eax),%edx
  10309d:	89 55 08             	mov    %edx,0x8(%ebp)
  1030a0:	0f b6 00             	movzbl (%eax),%eax
  1030a3:	84 c0                	test   %al,%al
  1030a5:	75 e5                	jne    10308c <strnlen+0xf>
    }
    return cnt;
...
__strcpy(char *dst, const char *src) {
    int d0, d1, d2;
    asm volatile (
  1030c2:	8b 55 f0             	mov    -0x10(%ebp),%edx
  ...
  1030d1:	aa                   	stos   %al,%es:(%edi)
  1030d2:	84 c0                	test   %al,%al
  1030d4:	75 fa                	jne    1030d0 <strcpy+0x22>
  1030d6:	89 fa                	mov    %edi,%edx
  1030d8:	89 f1                	mov    %esi,%ecx
  1030da:	89 4d ec             	mov    %ecx,-0x14(%ebp)
  1030dd:	89 55 e8             	mov    %edx,-0x18(%ebp)
...
strncpy(char *dst, const char *src, size_t len) {
  ...
  1030f6:	89 45 fc             	mov    %eax,-0x4(%ebp)
    while (len > 0) {
  1030f9:	eb 1e                	jmp    103119 <strncpy+0x2c>
        if ((*p = *src) != '\0') {
  1030fb:	8b 45 0c             	mov    0xc(%ebp),%eax
  1030fe:	0f b6 10             	movzbl (%eax),%edx
  103101:	8b 45 fc             	mov    -0x4(%ebp),%eax
  103104:	88 10                	mov    %dl,(%eax)
  103106:	8b 45 fc             	mov    -0x4(%ebp),%eax
  103109:	0f b6 00             	movzbl (%eax),%eax
  10310c:	84 c0                	test   %al,%al
  10310e:	74 03                	je     103113 <strncpy+0x26>
            src ++;
  103110:	ff 45 0c             	incl   0xc(%ebp)
        }
        p ++, len --;
  103113:	ff 45 fc             	incl   -0x4(%ebp)
  103116:	ff 4d 10             	decl   0x10(%ebp)
    while (len > 0) {
  103119:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
  10311d:	75 dc                	jne    1030fb <strncpy+0xe>
    }
    return dst;
...
strcmp(const char *s1, const char *s2) {
  ...
  103129:	57                   	push   %edi
  10312a:	56                   	push   %esi
  10312b:	83 ec 20             	sub    $0x20,%esp
  10312e:	8b 45 08             	mov    0x8(%ebp),%eax
  103131:	89 45 f4             	mov    %eax,-0xc(%ebp)
  103134:	8b 45 0c             	mov    0xc(%ebp),%eax
  103137:	89 45 f0             	mov    %eax,-0x10(%ebp)
    asm volatile (
  10313a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  10313d:	8b 45 f0             	mov    -0x10(%ebp),%eax
  103140:	89 d1                	mov    %edx,%ecx
  103142:	89 c2                	mov    %eax,%edx
  103144:	89 ce                	mov    %ecx,%esi
  103146:	89 d7                	mov    %edx,%edi
  103148:	ac                   	lods   %ds:(%esi),%al
  103149:	ae                   	scas   %es:(%edi),%al
  10314a:	75 08                	jne    103154 <strcmp+0x2e>
  10314c:	84 c0                	test   %al,%al
  10314e:	75 f8                	jne    103148 <strcmp+0x22>
  103150:	31 c0                	xor    %eax,%eax
  103152:	eb 04                	jmp    103158 <strcmp+0x32>
  103154:	19 c0                	sbb    %eax,%eax
  103156:	0c 01                	or     $0x1,%al
  103158:	89 fa                	mov    %edi,%edx
  10315a:	89 f1                	mov    %esi,%ecx
  10315c:	89 45 ec             	mov    %eax,-0x14(%ebp)
  10315f:	89 4d e8             	mov    %ecx,-0x18(%ebp)
  103162:	89 55 e4             	mov    %edx,-0x1c(%ebp)
    return ret;
...
strncmp(const char *s1, const char *s2, size_t n) {
  10316f:	55                   	push   %ebp
  103170:	89 e5                	mov    %esp,%ebp
    while (n > 0 && *s1 != '\0' && *s1 == *s2) {
  103172:	eb 09                	jmp    10317d <strncmp+0xe>
        n --, s1 ++, s2 ++;
  103174:	ff 4d 10             	decl   0x10(%ebp)
  103177:	ff 45 08             	incl   0x8(%ebp)
  10317a:	ff 45 0c             	incl   0xc(%ebp)
    while (n > 0 && *s1 != '\0' && *s1 == *s2) {
  10317d:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
  103181:	74 1a                	je     10319d <strncmp+0x2e>
  103183:	8b 45 08             	mov    0x8(%ebp),%eax
  103186:	0f b6 00             	movzbl (%eax),%eax
  103189:	84 c0                	test   %al,%al
  10318b:	74 10                	je     10319d <strncmp+0x2e>
  10318d:	8b 45 08             	mov    0x8(%ebp),%eax
  103190:	0f b6 10             	movzbl (%eax),%edx
  103193:	8b 45 0c             	mov    0xc(%ebp),%eax
  103196:	0f b6 00             	movzbl (%eax),%eax
  103199:	38 c2                	cmp    %al,%dl
  10319b:	74 d7                	je     103174 <strncmp+0x5>
    }
    return (n == 0) ? 0 : (int)((unsigned char)*s1 - (unsigned char)*s2);
  10319d:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
  1031a1:	74 18                	je     1031bb <strncmp+0x4c>
  1031a3:	8b 45 08             	mov    0x8(%ebp),%eax
  1031a6:	0f b6 00             	movzbl (%eax),%eax
  1031a9:	0f b6 d0             	movzbl %al,%edx
  1031ac:	8b 45 0c             	mov    0xc(%ebp),%eax
  1031af:	0f b6 00             	movzbl (%eax),%eax
  1031b2:	0f b6 c8             	movzbl %al,%ecx
  1031b5:	89 d0                	mov    %edx,%eax
  1031b7:	29 c8                	sub    %ecx,%eax
  1031b9:	eb 05                	jmp    1031c0 <strncmp+0x51>
  1031bb:	b8 00 00 00 00       	mov    $0x0,%eax
}
  1031c0:	5d                   	pop    %ebp
  1031c1:	c3                   	ret    
...
strchr(const char *s, char c) {
  ...
  1031c5:	83 ec 04             	sub    $0x4,%esp
  1031c8:	8b 45 0c             	mov    0xc(%ebp),%eax
  1031cb:	88 45 fc             	mov    %al,-0x4(%ebp)
    while (*s != '\0') {
  1031ce:	eb 13                	jmp    1031e3 <strchr+0x21>
        if (*s == c) {
  1031d0:	8b 45 08             	mov    0x8(%ebp),%eax
  1031d3:	0f b6 00             	movzbl (%eax),%eax
  1031d6:	38 45 fc             	cmp    %al,-0x4(%ebp)
  1031d9:	75 05                	jne    1031e0 <strchr+0x1e>
            return (char *)s;
  1031db:	8b 45 08             	mov    0x8(%ebp),%eax
  1031de:	eb 12                	jmp    1031f2 <strchr+0x30>
        }
        s ++;
  1031e0:	ff 45 08             	incl   0x8(%ebp)
    while (*s != '\0') {
  1031e3:	8b 45 08             	mov    0x8(%ebp),%eax
  1031e6:	0f b6 00             	movzbl (%eax),%eax
  1031e9:	84 c0                	test   %al,%al
  1031eb:	75 e3                	jne    1031d0 <strchr+0xe>
    }
    return NULL;
  1031ed:	b8 00 00 00 00       	mov    $0x0,%eax
}
  1031f2:	89 ec                	mov    %ebp,%esp
  1031f4:	5d                   	pop    %ebp
  1031f5:	c3                   	ret    
...
strfind(const char *s, char c) {
  ...
  1031f9:	83 ec 04             	sub    $0x4,%esp
  1031fc:	8b 45 0c             	mov    0xc(%ebp),%eax
  1031ff:	88 45 fc             	mov    %al,-0x4(%ebp)
    while (*s != '\0') {
  103202:	eb 0e                	jmp    103212 <strfind+0x1c>
        if (*s == c) {
  103204:	8b 45 08             	mov    0x8(%ebp),%eax
  103207:	0f b6 00             	movzbl (%eax),%eax
  10320a:	38 45 fc             	cmp    %al,-0x4(%ebp)
  10320d:	74 0f                	je     10321e <strfind+0x28>
            break;
        }
        s ++;
  ...
  103218:	84 c0                	test   %al,%al
  10321a:	75 e8                	jne    103204 <strfind+0xe>
  10321c:	eb 01                	jmp    10321f <strfind+0x29>
            break;
  10321e:	90                   	nop
    }
    return (char *)s;
...
strtol(const char *s, char **endptr, int base) {
  ...
  103229:	83 ec 10             	sub    $0x10,%esp
    int neg = 0;
  10322c:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
    long val = 0;
  103233:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)

    // gobble initial whitespace
    while (*s == ' ' || *s == '\t') {
  10323a:	eb 03                	jmp    10323f <strtol+0x19>
        s ++;
  10323c:	ff 45 08             	incl   0x8(%ebp)
    while (*s == ' ' || *s == '\t') {
  10323f:	8b 45 08             	mov    0x8(%ebp),%eax
  103242:	0f b6 00             	movzbl (%eax),%eax
  103245:	3c 20                	cmp    $0x20,%al
  103247:	74 f3                	je     10323c <strtol+0x16>
  103249:	8b 45 08             	mov    0x8(%ebp),%eax
  10324c:	0f b6 00             	movzbl (%eax),%eax
  10324f:	3c 09                	cmp    $0x9,%al
  103251:	74 e9                	je     10323c <strtol+0x16>
    }
  ...
  103259:	3c 2b                	cmp    $0x2b,%al
  10325b:	75 05                	jne    103262 <strtol+0x3c>
        s ++;
  10325d:	ff 45 08             	incl   0x8(%ebp)
  103260:	eb 14                	jmp    103276 <strtol+0x50>
    }
    else if (*s == '-') {
  103262:	8b 45 08             	mov    0x8(%ebp),%eax
  103265:	0f b6 00             	movzbl (%eax),%eax
  103268:	3c 2d                	cmp    $0x2d,%al
  10326a:	75 0a                	jne    103276 <strtol+0x50>
        s ++, neg = 1;
  10326c:	ff 45 08             	incl   0x8(%ebp)
  10326f:	c7 45 fc 01 00 00 00 	movl   $0x1,-0x4(%ebp)
    }

    // hex or octal base prefix
    if ((base == 0 || base == 16) && (s[0] == '0' && s[1] == 'x')) {
  103276:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
  10327a:	74 06                	je     103282 <strtol+0x5c>
  10327c:	83 7d 10 10          	cmpl   $0x10,0x10(%ebp)
  103280:	75 22                	jne    1032a4 <strtol+0x7e>
  103282:	8b 45 08             	mov    0x8(%ebp),%eax
  103285:	0f b6 00             	movzbl (%eax),%eax
  103288:	3c 30                	cmp    $0x30,%al
  10328a:	75 18                	jne    1032a4 <strtol+0x7e>
  10328c:	8b 45 08             	mov    0x8(%ebp),%eax
  10328f:	40                   	inc    %eax
  103290:	0f b6 00             	movzbl (%eax),%eax
  103293:	3c 78                	cmp    $0x78,%al
  103295:	75 0d                	jne    1032a4 <strtol+0x7e>
        s += 2, base = 16;
  103297:	83 45 08 02          	addl   $0x2,0x8(%ebp)
  10329b:	c7 45 10 10 00 00 00 	movl   $0x10,0x10(%ebp)
  1032a2:	eb 29                	jmp    1032cd <strtol+0xa7>
    }
    else if (base == 0 && s[0] == '0') {
  1032a4:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
  1032a8:	75 16                	jne    1032c0 <strtol+0x9a>
  1032aa:	8b 45 08             	mov    0x8(%ebp),%eax
  1032ad:	0f b6 00             	movzbl (%eax),%eax
  1032b0:	3c 30                	cmp    $0x30,%al
  1032b2:	75 0c                	jne    1032c0 <strtol+0x9a>
        s ++, base = 8;
  1032b4:	ff 45 08             	incl   0x8(%ebp)
  1032b7:	c7 45 10 08 00 00 00 	movl   $0x8,0x10(%ebp)
  1032be:	eb 0d                	jmp    1032cd <strtol+0xa7>
    }
    else if (base == 0) {
  1032c0:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
  1032c4:	75 07                	jne    1032cd <strtol+0xa7>
        base = 10;
  1032c6:	c7 45 10 0a 00 00 00 	movl   $0xa,0x10(%ebp)
  ...
  1032d3:	3c 2f                	cmp    $0x2f,%al
  1032d5:	7e 1b                	jle    1032f2 <strtol+0xcc>
  1032d7:	8b 45 08             	mov    0x8(%ebp),%eax
  1032da:	0f b6 00             	movzbl (%eax),%eax
  1032dd:	3c 39                	cmp    $0x39,%al
  1032df:	7f 11                	jg     1032f2 <strtol+0xcc>
            dig = *s - '0';
  1032e1:	8b 45 08             	mov    0x8(%ebp),%eax
  1032e4:	0f b6 00             	movzbl (%eax),%eax
  1032e7:	0f be c0             	movsbl %al,%eax
  1032ea:	83 e8 30             	sub    $0x30,%eax
  1032ed:	89 45 f4             	mov    %eax,-0xc(%ebp)
  1032f0:	eb 48                	jmp    10333a <strtol+0x114>
        }
        else if (*s >= 'a' && *s <= 'z') {
  1032f2:	8b 45 08             	mov    0x8(%ebp),%eax
  1032f5:	0f b6 00             	movzbl (%eax),%eax
  1032f8:	3c 60                	cmp    $0x60,%al
  1032fa:	7e 1b                	jle    103317 <strtol+0xf1>
  1032fc:	8b 45 08             	mov    0x8(%ebp),%eax
  1032ff:	0f b6 00             	movzbl (%eax),%eax
  103302:	3c 7a                	cmp    $0x7a,%al
  103304:	7f 11                	jg     103317 <strtol+0xf1>
            dig = *s - 'a' + 10;
  103306:	8b 45 08             	mov    0x8(%ebp),%eax
  103309:	0f b6 00             	movzbl (%eax),%eax
  10330c:	0f be c0             	movsbl %al,%eax
  10330f:	83 e8 57             	sub    $0x57,%eax
  103312:	89 45 f4             	mov    %eax,-0xc(%ebp)
  103315:	eb 23                	jmp    10333a <strtol+0x114>
        }
        else if (*s >= 'A' && *s <= 'Z') {
  103317:	8b 45 08             	mov    0x8(%ebp),%eax
  10331a:	0f b6 00             	movzbl (%eax),%eax
  10331d:	3c 40                	cmp    $0x40,%al
  10331f:	7e 3b                	jle    10335c <strtol+0x136>
  103321:	8b 45 08             	mov    0x8(%ebp),%eax
  103324:	0f b6 00             	movzbl (%eax),%eax
  103327:	3c 5a                	cmp    $0x5a,%al
  103329:	7f 31                	jg     10335c <strtol+0x136>
            dig = *s - 'A' + 10;
  10332b:	8b 45 08             	mov    0x8(%ebp),%eax
  10332e:	0f b6 00             	movzbl (%eax),%eax
  103331:	0f be c0             	movsbl %al,%eax
  103334:	83 e8 37             	sub    $0x37,%eax
  103337:	89 45 f4             	mov    %eax,-0xc(%ebp)
        }
        else {
            break;
        }
  ...
  10333d:	3b 45 10             	cmp    0x10(%ebp),%eax
  103340:	7d 19                	jge    10335b <strtol+0x135>
            break;
        }
        s ++, val = (val * base) + dig;
  103342:	ff 45 08             	incl   0x8(%ebp)
  103345:	8b 45 f8             	mov    -0x8(%ebp),%eax
  103348:	0f af 45 10          	imul   0x10(%ebp),%eax
  10334c:	89 c2                	mov    %eax,%edx
  10334e:	8b 45 f4             	mov    -0xc(%ebp),%eax
  103351:	01 d0                	add    %edx,%eax
  103353:	89 45 f8             	mov    %eax,-0x8(%ebp)
    while (1) {
  103356:	e9 72 ff ff ff       	jmp    1032cd <strtol+0xa7>
            break;
  10335b:	90                   	nop
    ...
    if (endptr) {
  10335c:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
  103360:	74 08                	je     10336a <strtol+0x144>
        *endptr = (char *) s;
  103362:	8b 45 0c             	mov    0xc(%ebp),%eax
  103365:	8b 55 08             	mov    0x8(%ebp),%edx
  103368:	89 10                	mov    %edx,(%eax)
    }
    return (neg ? -val : val);
  10336a:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
  10336e:	74 07                	je     103377 <strtol+0x151>
  103370:	8b 45 f8             	mov    -0x8(%ebp),%eax
  103373:	f7 d8                	neg    %eax
  103375:	eb 03                	jmp    10337a <strtol+0x154>
  103377:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
  10337a:	89 ec                	mov    %ebp,%esp
  10337c:	5d                   	pop    %ebp
  10337d:	c3                   	ret    
...
memset(void *s, char c, size_t n) {
  ...
  103381:	83 ec 28             	sub    $0x28,%esp
  103384:	89 7d fc             	mov    %edi,-0x4(%ebp)
  103387:	8b 45 0c             	mov    0xc(%ebp),%eax
  10338a:	88 45 d8             	mov    %al,-0x28(%ebp)
#ifdef __HAVE_ARCH_MEMSET
    return __memset(s, c, n);
  10338d:	0f be 55 d8          	movsbl -0x28(%ebp),%edx
  103391:	8b 45 08             	mov    0x8(%ebp),%eax
  103394:	89 45 f8             	mov    %eax,-0x8(%ebp)
  103397:	88 55 f7             	mov    %dl,-0x9(%ebp)
  10339a:	8b 45 10             	mov    0x10(%ebp),%eax
...
__memset(void *s, char c, size_t n) {
    int d0, d1;
    asm volatile (
  1033a0:	8b 4d f0             	mov    -0x10(%ebp),%ecx
  1033a3:	0f b6 45 f7          	movzbl -0x9(%ebp),%eax
  1033a7:	8b 55 f8             	mov    -0x8(%ebp),%edx
  1033aa:	89 d7                	mov    %edx,%edi
  1033ac:	f3 aa                	rep stos %al,%es:(%edi)
  1033ae:	89 fa                	mov    %edi,%edx
  1033b0:	89 4d ec             	mov    %ecx,-0x14(%ebp)
  1033b3:	89 55 e8             	mov    %edx,-0x18(%ebp)
            "rep; stosb;"
            : "=&c" (d0), "=&D" (d1)
            : "0" (n), "a" (c), "1" (s)
            : "memory");
  ...
  1033b9:	8b 7d fc             	mov    -0x4(%ebp),%edi
  1033bc:	89 ec                	mov    %ebp,%esp
  1033be:	5d                   	pop    %ebp
  1033bf:	c3                   	ret    
...
memmove(void *dst, const void *src, size_t n) {
  ...
  1033d8:	89 45 e8             	mov    %eax,-0x18(%ebp)
...
__memmove(void *dst, const void *src, size_t n) {
    if (dst < src) {
  1033db:	8b 45 f0             	mov    -0x10(%ebp),%eax
  1033de:	3b 45 ec             	cmp    -0x14(%ebp),%eax
  1033e1:	73 42                	jae    103425 <memmove+0x65>
  1033e3:	8b 45 f0             	mov    -0x10(%ebp),%eax
  1033e6:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  1033e9:	8b 45 ec             	mov    -0x14(%ebp),%eax
  1033ec:	89 45 e0             	mov    %eax,-0x20(%ebp)
  1033ef:	8b 45 e8             	mov    -0x18(%ebp),%eax
  1033f2:	89 45 dc             	mov    %eax,-0x24(%ebp)
            "andl $3, %%ecx;"
            "jz 1f;"
            "rep; movsb;"
            "1:"
  ...
  1033f8:	c1 e8 02             	shr    $0x2,%eax
  1033fb:	89 c1                	mov    %eax,%ecx
    asm volatile (
  1033fd:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  103400:	8b 45 e0             	mov    -0x20(%ebp),%eax
  103403:	89 d7                	mov    %edx,%edi
  103405:	89 c6                	mov    %eax,%esi
  103407:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  103409:	8b 4d dc             	mov    -0x24(%ebp),%ecx
  10340c:	83 e1 03             	and    $0x3,%ecx
  10340f:	74 02                	je     103413 <memmove+0x53>
  103411:	f3 a4                	rep movsb %ds:(%esi),%es:(%edi)
  103413:	89 f0                	mov    %esi,%eax
  103415:	89 fa                	mov    %edi,%edx
  103417:	89 4d d8             	mov    %ecx,-0x28(%ebp)
  10341a:	89 55 d4             	mov    %edx,-0x2c(%ebp)
  10341d:	89 45 d0             	mov    %eax,-0x30(%ebp)
            : "memory");
    return dst;
  103420:	8b 45 e4             	mov    -0x1c(%ebp),%eax
        return __memcpy(dst, src, n);
  103423:	eb 36                	jmp    10345b <memmove+0x9b>
            : "0" (n), "1" (n - 1 + src), "2" (n - 1 + dst)
  103425:	8b 45 e8             	mov    -0x18(%ebp),%eax
  103428:	8d 50 ff             	lea    -0x1(%eax),%edx
  10342b:	8b 45 ec             	mov    -0x14(%ebp),%eax
  10342e:	01 c2                	add    %eax,%edx
  103430:	8b 45 e8             	mov    -0x18(%ebp),%eax
  103433:	8d 48 ff             	lea    -0x1(%eax),%ecx
  103436:	8b 45 f0             	mov    -0x10(%ebp),%eax
  103439:	8d 1c 01             	lea    (%ecx,%eax,1),%ebx
    asm volatile (
  10343c:	8b 45 e8             	mov    -0x18(%ebp),%eax
  10343f:	89 c1                	mov    %eax,%ecx
  103441:	89 d8                	mov    %ebx,%eax
  103443:	89 d6                	mov    %edx,%esi
  103445:	89 c7                	mov    %eax,%edi
  103447:	fd                   	std    
  103448:	f3 a4                	rep movsb %ds:(%esi),%es:(%edi)
  10344a:	fc                   	cld    
  10344b:	89 f8                	mov    %edi,%eax
  10344d:	89 f2                	mov    %esi,%edx
  10344f:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  103452:	89 55 c8             	mov    %edx,-0x38(%ebp)
  103455:	89 45 c4             	mov    %eax,-0x3c(%ebp)
    return dst;
  103458:	8b 45 f0             	mov    -0x10(%ebp),%eax
            *d ++ = *s ++;
        }
    }
    return dst;
...
memcpy(void *dst, const void *src, size_t n) {
  ...
  103477:	8b 45 10             	mov    0x10(%ebp),%eax
  10347a:	89 45 ec             	mov    %eax,-0x14(%ebp)
            : "0" (n / 4), "g" (n), "1" (dst), "2" (src)
  10347d:	8b 45 ec             	mov    -0x14(%ebp),%eax
  103480:	c1 e8 02             	shr    $0x2,%eax
  103483:	89 c1                	mov    %eax,%ecx
    asm volatile (
  103485:	8b 55 f4             	mov    -0xc(%ebp),%edx
  103488:	8b 45 f0             	mov    -0x10(%ebp),%eax
  10348b:	89 d7                	mov    %edx,%edi
  10348d:	89 c6                	mov    %eax,%esi
  10348f:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  103491:	8b 4d ec             	mov    -0x14(%ebp),%ecx
  103494:	83 e1 03             	and    $0x3,%ecx
  103497:	74 02                	je     10349b <memcpy+0x38>
  103499:	f3 a4                	rep movsb %ds:(%esi),%es:(%edi)
  10349b:	89 f0                	mov    %esi,%eax
  10349d:	89 fa                	mov    %edi,%edx
  10349f:	89 4d e8             	mov    %ecx,-0x18(%ebp)
  1034a2:	89 55 e4             	mov    %edx,-0x1c(%ebp)
...
memcmp(const void *v1, const void *v2, size_t n) {
  ...
  1034bb:	89 45 fc             	mov    %eax,-0x4(%ebp)
    const char *s2 = (const char *)v2;
  1034be:	8b 45 0c             	mov    0xc(%ebp),%eax
  1034c1:	89 45 f8             	mov    %eax,-0x8(%ebp)
    while (n -- > 0) {
  1034c4:	eb 2e                	jmp    1034f4 <memcmp+0x42>
        if (*s1 != *s2) {
  1034c6:	8b 45 fc             	mov    -0x4(%ebp),%eax
  1034c9:	0f b6 10             	movzbl (%eax),%edx
  1034cc:	8b 45 f8             	mov    -0x8(%ebp),%eax
  1034cf:	0f b6 00             	movzbl (%eax),%eax
  1034d2:	38 c2                	cmp    %al,%dl
  1034d4:	74 18                	je     1034ee <memcmp+0x3c>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
  1034d6:	8b 45 fc             	mov    -0x4(%ebp),%eax
  1034d9:	0f b6 00             	movzbl (%eax),%eax
  1034dc:	0f b6 d0             	movzbl %al,%edx
  1034df:	8b 45 f8             	mov    -0x8(%ebp),%eax
  1034e2:	0f b6 00             	movzbl (%eax),%eax
  1034e5:	0f b6 c8             	movzbl %al,%ecx
  1034e8:	89 d0                	mov    %edx,%eax
  1034ea:	29 c8                	sub    %ecx,%eax
  1034ec:	eb 18                	jmp    103506 <memcmp+0x54>
        }
        s1 ++, s2 ++;
  1034ee:	ff 45 fc             	incl   -0x4(%ebp)
  1034f1:	ff 45 f8             	incl   -0x8(%ebp)
    while (n -- > 0) {
  1034f4:	8b 45 10             	mov    0x10(%ebp),%eax
  1034f7:	8d 50 ff             	lea    -0x1(%eax),%edx
  1034fa:	89 55 10             	mov    %edx,0x10(%ebp)
  1034fd:	85 c0                	test   %eax,%eax
  1034ff:	75 c5                	jne    1034c6 <memcmp+0x14>
    }
    return 0;
  103501:	b8 00 00 00 00       	mov    $0x0,%eax
}
  103506:	89 ec                	mov    %ebp,%esp
  103508:	5d                   	pop    %ebp
  103509:	c3                   	ret    
